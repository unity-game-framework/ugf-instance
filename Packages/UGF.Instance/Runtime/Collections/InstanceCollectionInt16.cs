...
{
    /// <summary>
    /// The implementation of the <see cref="InstanceCollection{TIdentifier,TInstance}"/> with Int16 as identifier.
    /// </summary>
    public class InstanceCollectionInt16<TInstance> : InstanceCollection<short, TInstance>
    {
        /// <summary>
