...
{
    /// <summary>
    /// The implementation of the <see cref="InstanceCollection{TIdentifier,TInstance}"/> with UInt64 as identifier.
    /// </summary>
    public class InstanceCollectionUInt64<TInstance> : InstanceCollection<ulong, TInstance>
    {
        /// <summary>
